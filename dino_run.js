...
// include: /tmp/tmphu799te1.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'dino_run.data';
      var REMOTE_PACKAGE_BASE = 'dino_run.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_dino_run.data');

      };
      Module['addRunDependency']('datafile_dino_run.data');
    ...
    loadPackage({"files": [{"filename": "/assets/bigCactus.png", "start": 0, "end": 551}, {"filename": "/assets/cloud.png", "start": 551, "end": 1040}, {"filename": "/assets/ground.png", "start": 1040, "end": 1686}, {"filename": "/assets/pterodatyl.png", "start": 1686, "end": 2218}, {"filename": "/assets/smallCactus.png", "start": 2218, "end": 2701}, {"filename": "/assets/sprite.png", "start": 2701, "end": 5811}, {"filename": "/assets/trex.png", "start": 5811, "end": 6421}, {"filename": "/assets/trexDuck.png", "start": 6421, "end": 7012}], "remote_package_size": 7012});

  })();

// end include: /tmp/tmphu799te1.js
// include: /tmp/tmpc_lkxvla.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpc_lkxvla.js
// include: /tmp/tmpt0bn1uyy.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpt0bn1uyy.js
...
function findWasmBinary() {
    return locateFile('dino_run.wasm');
}
